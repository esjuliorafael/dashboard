...
export const CategoryWidget: React.FC = () => {
  return (
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-stone-400 text-[9px] font-bold uppercase tracking-widest leading-none">Categorías</span>
            <div className="flex items-baseline gap-1.5 mt-1">
              <h3 className="text-lg font-black text-stone-800 leading-none">18</h3>
              <span className="text-stone-400 text-[9px] font-medium uppercase leading-none">Activas</span>
            </div>
          </div>
        </div>
        <button className="text-stone-300 hover:text-brand-600 transition-colors group p-1 shrink-0">
